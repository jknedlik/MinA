...
int main(){
  ...
  //IMPORTANT::must be inside a scope(brackets); Writing the object to the archive (and file )
  {
  ...
  //IMPORTANT::must be inside a scope(brackets);Creating an object and read in from that exact file to the object)
  Coolmap B;
  {
