...
int main(int argc, char** argv)
{
 ...
 if (cx) {
  ...
  mc5.setMetaParameters(
    vectorToTuple<std::tuple_size<decltype(mc5.getMetaParameters())>::value>(
      v));
  mc5.setFileName(".MultiTest2.mc5");
  mc2.setMetaParameters(
    vectorToTuple<std::tuple_size<decltype(mc2.getMetaParameters())>::value>(
      v));
  mc2.setFileName(".Multitest2.mc2");
  mc10.setMetaParameters(
    vectorToTuple<std::tuple_size<decltype(mc10.getMetaParameters())>::value>(
      v));
